...
const STATUS_OPTIONS = [
  { value: 'PENDING', label: 'Төлбөр хүлээгдэж буй', color: 'bg-amber-100 text-amber-800' },
  { value: 'PAID', label: 'Төлбөр орсон', color: 'bg-blue-100 text-blue-800' },
  ...
  { value: 'NO_SHOW', label: 'Ирээгүй', color: 'bg-orange-100 text-orange-800' },
